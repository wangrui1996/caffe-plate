...
def WarpctcNetBody(net, data_layer):
#  lstm_kwargs = {
...
#  assert from_layer in net.keys()  # 48 x 48
  ...
  net.indicator = L.ContinuationIndicator(time_step=80, batch_size=512)
  ...
  net.fc1 = L.InnerProduct(net.lstm2, num_output=11, axis=2, **kwargs)
